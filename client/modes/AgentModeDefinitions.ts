...
import { GenerateCerebrusActionUtil } from '../actions/GenerateCerebrusActionUtil'
...
import { SpawnArtifactActionUtil } from '../actions/SpawnArtifactActionUtil'
import { StackActionUtil } from '../actions/StackActionUtil'
import { StartOrchestrationActionUtil } from '../actions/StartOrchestrationActionUtil'
...
export const AGENT_MODE_DEFINITIONS = [
	...
	},
	{
		...
		actions: [
			...
			SpawnArtifactActionUtil.type,
			GenerateCerebrusActionUtil.type,
			StartOrchestrationActionUtil.type,
