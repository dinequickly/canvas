...
export type AgentRequestUiOrigin = 'dock' | 'chat-panel' | 'unknown'
...
export interface AgentRequest {
	...
	/**
	 * Optional request identifier used to correlate request-side UI state
	 * with streamed actions and async handoff results.
	 */
	requestId?: string

	/**
	 * Optional UI surface that originated the request.
	 */
